...
#define __BUILD_JPG_WRITE_SUPPORT__		1
...
#define __BUILD_USBD480LIBUSB__			1		// USBD480 through libusb0 (non HID firmware). HI-Speed USB display interface controller (www.lcdinfo.com) for the Sharp LQ043 LCD (480x272)
...
#define __BUILD_USBD480DLL__			1		// USBD480 through USBD480_lib.dll. HI-Speed USB display controller (www.lcdinfo.com) for the Sharp LQ043 LCD (480x272)
#define __BUILD_USBD480__				1		// USBD480 through libusb0 and HID (composite interface, if0).
#define __BUILD_G15DISPLAY__			1		// requires Logitech driver software (tested with v1.02/04). Links to lglcd.lib
