...
#define POINTDELTA (16*8)
#define TBINPUTLENGTH 4
...
typedef struct {
	TTPOINT refPoint[TOUCHCALPOINTS];	// ideal position of reference points
	TTPOINT samPoint[TOUCHCALPOINTS];	// sampling position of reference points
