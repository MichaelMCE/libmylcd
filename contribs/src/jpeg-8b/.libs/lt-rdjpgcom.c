...
/* ./.libs/lt-rdjpgcom.c - temporary wrapper executable for .libs/rdjpgcom.exe
   Generated by libtool (GNU libtool 1.3110 2009-07-01) 2.2.7a

   The rdjpgcom program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh rdjpgcom",
   but could eventually absorb all of the scripts functionality and
   exec .libs/rdjpgcom.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "rdjpgcom.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# rdjpgcom - temporary wrapper script for .libs/rdjpgcom.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3110 2009-07-01) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The rdjpgcom program cannot be directly executed until all the libtool\n", f);
