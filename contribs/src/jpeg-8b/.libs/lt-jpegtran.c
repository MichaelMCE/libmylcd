...
/* ./.libs/lt-jpegtran.c - temporary wrapper executable for .libs/jpegtran.exe
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh jpegtran",
   but could eventually absorb all of the scripts functionality and
   exec .libs/jpegtran.exe directly.
*/
#ifdef _MSC_VER
...
const char * TARGET_PROGRAM_NAME = "jpegtran.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# jpegtran - temporary wrapper script for .libs/jpegtran.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3110 2009-07-01) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The jpegtran program cannot be directly executed until all the libtool\n", f);
