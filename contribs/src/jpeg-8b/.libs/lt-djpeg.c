...
/* ./.libs/lt-djpeg.c - temporary wrapper executable for .libs/djpeg.exe
   Generated by libtool (GNU libtool 1.3110 2009-07-01) 2.2.7a

   The djpeg program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh djpeg",
   but could eventually absorb all of the scripts functionality and
   exec .libs/djpeg.exe directly.
*/
#ifdef _MSC_VER
...
const char * LIB_PATH_VALUE   = "k:\\code\\mylcd\\contribs\\src\\jpeg-8b\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "k;R:\\MSYS_MinGW-w64_GCC_480_x86-x64_Full\\MSYS\\code\\mylcd\\contribs\\src\\jpeg-8b\\.libs;R:\\MSYS_MinGW-w64_GCC_480_x86-x64_Full\\MSYS\\local\\lib;R:\\MSYS_MinGW-w64_GCC_480_x86-x64_Full\\MSYS\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "djpeg.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# djpeg - temporary wrapper script for .libs/djpeg.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool 1.3110 2009-07-01) 2.2.7a\n", f);
  fputs ("#\n", f);
  fputs ("# The djpeg program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libjpeg.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("# windows platforms, and (c) all exist in the --lt- namespace\n", f);
  ...
  fputs ("}\n", f);
  fputs ("\n", f);
  fputs ("# Sets opts_contain_lt_result to \"yes\" if the\n", f);
  fputs ("# supplied arguments contain any elements in the\n", f);
  fputs ("# --lt-* namespace. Empty otherwise.\n", f);
  fputs ("opts_contain_lt_result=\n", f);
  fputs ("func_opts_contain_lt ()\n", f);
  fputs ("{\n", f);
  fputs ("  opts_contain_lt_result=\n", f);
  fputs ("  for lt_option\n", f);
  fputs ("  do\n", f);
  fputs ("    case \"$lt_option\" in\n", f);
  fputs ("    --lt-*) opts_contain_lt_result=yes\n", f);
  fputs ("            break ;;\n", f);
  fputs ("    *) ;;\n", f);
  fputs ("    esac\n", f);
  fputs ("  done\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"(main) newargz[$lt_dump_args_N]   : $lt_arg\"\n", f);
  ...
  fputs ("        $ECHO \"(main) lt_argv_zero : $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("{\n", f);
  fputs ("  func_opts_contain_lt ${1+\"$@\"}\n", f);
  fputs ("  if test -n \"$opts_contain_lt_result\"; then\n", f);
  fputs ("    # the following is adapted from _AC_INIT_PREPARE, except\n", f);
  fputs ("    # (1) we don't care about duplicates, and\n", f);
  fputs ("    # (2) we strip out --lt-*, not --no-create/--no-recursion/--silent\n", f);
  fputs ("    lt_wrapper_args=\n", f);
  fputs ("    for lt_wr_arg\n", f);
  fputs ("    do\n", f);
  fputs ("      case $lt_wr_arg in\n", f);
  fputs ("      --lt-*) continue ;;\n", f);
  fputs ("      *\\'*)\n", f);
  fputs ("        lt_wr_arg=`$ECHO \"X$lt_wr_arg\" |\n", f);
  fputs ("          /usr/bin/sed -e \"s/^X//\" -e \"s/'/'\\\\\\\\\\\\\\\\''/g\"`\n", f);
  fputs ("        ;;\n", f);
  fputs ("      esac\n", f);
  fputs ("      lt_wrapper_args=\"$lt_wrapper_args '$lt_wr_arg'\"\n", f);
  fputs ("    done\n", f);
  fputs ("    eval func_exec_program_core $lt_wrapper_args\n", f);
  fputs ("  else\n", f);
  ...
  fputs ("    PATH=k:/code/mylcd/contribs/src/jpeg-8b/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
