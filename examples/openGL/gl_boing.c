...
#define BOUNCE_HEIGHT   (RADIUS * 3.0)
#define BOUNCE_WIDTH    (RADIUS * 6.0)
...
int main (void)
{
   ...
   /*if (!glfwOpenWindow( DWIDTH,DHEIGHT, 0,0,0,0, 24,0, GLFW_WINDOW)){
       glfwTerminate();
       return 0;
   }*/
   //glfwSetWindowTitle( "Boing (classic Amiga demo)" );
   //glfwSetWindowSizeCallback( reshape );
	reshape(DWIDTH, DHEIGHT);
