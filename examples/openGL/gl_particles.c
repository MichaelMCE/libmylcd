...
#define BATCH_PARTICLES 32 // Number of particles to draw in each batch
...
int main (int argc, char **argv )
{
    ...
    for( i = 1; i < argc; i ++ )
    {
        ...
        else
        {
            ...
            printf( "\n");
            printf( "Options:\n" );
            printf( " -b   Benchmark (run program for 10s)\n" );
    ...
    if( !glfwOpenWindow( DWIDTH, DHEIGHT, 5,6,5,0, 16,0, GLFW_WINDOW ) ){
        glfwTerminate();
        exit( 0 );
    }*/
